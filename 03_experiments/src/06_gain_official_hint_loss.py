...
def main():
    ...
    for iteration in range(1, iterations + 1):
        ...
        # Small random noise for missing entries.
        ...
        # --------------------------------------------------
        # Official released-code hint mechanism
        # --------------------------------------------------
        ...
        # H = M * H_temp
        #
        # The hint reveals only a subset of observed entries.
        # No 0.5-valued uncertain hint is used here.
        hint = m_batch * hint_selector
        ...
        # Official released implementation computes
        # discriminator classification loss over all entries.
        d_loss = d_loss_matrix.mean()
        ...
        # Official released implementation applies
        # adversarial loss to missing entries and
        # takes a mean over the complete matrix.
        g_adv_loss = -(
            (1.0 - m_batch)
        ...
        writer.writerow(
            {
                ...
                "variant": "official-code-oriented",
    ...
    print("----- GAIN RESULT -----")
    print(f"Experiment: {experiment_id}")
    print("Variant: official-code-oriented")
